...
#### Решение 
1.
![](https://github.com/michail-77/mnt-homeworks/blob/MNT-video/08-ansible-05-testing/image/1.jpg)
2.
```bash
...
![](https://github.com/michail-77/mnt-homeworks/blob/MNT-video/08-ansible-05-testing/image/2.jpg)
...
[Ссылка](https://github.com/michail-77/roles/blob/main/vector-role/vars/main.yml)
