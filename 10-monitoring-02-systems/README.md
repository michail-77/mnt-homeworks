...
`./data:/var/lib:Z`
### Ответ: 
![web_status](https://github.com/michail-77/mnt-homeworks/blob/MNT-video/10-monitoring-02-systems/image/web_status.JPG)
...
### Ответ:  
![docker](https://github.com/michail-77/mnt-homeworks/blob/MNT-video/10-monitoring-02-systems/image/docker.png)
